...
class EOrderItems extends Model
{
    ...
    protected $fillable =  [
        'company_name_check','item_code', 'item_name', 'user_id', 'warehouse_id', 'business_id', 'description', 'unit_of_measurement', 'size', 'quantity', 'brand', 'last_price', 'delivery_period', 'remarks', 'file_path', 'required_sample', 'payment_mode', 'order_id', 'status', 'bypass', 'quotation_time', 'rfq_type'
    ];
