...
{{--                    <x-jet-label for="gender" value="{{ __('اللقب') }}" class="mb-2" />--}}
                    ...
                    <select name="gender" id="gender" class="form-select mb-2 rounded-md shadow-sm block w-full" required autofocus autocomplete="name" >
                        ...
                        <option value="Male">{{ __('register.Ms.') }}</option>
            ...
            <div class="flex flex-wrap  lg:-mx-2 xl:-mx-2">
                ...
                <div class="w-full overflow-hidden lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
                    ...
                    <input type="text" id="datepicker" class="block mt-1 w-full" name="nid_exp_date" placeholder="{{__('register.Choose Date')}} (mm/dd/yy)" readonly>
                </div>
            ...
            <div class="mt-2" style="direction: ltr;">
                <x-jet-label for="mobile" value="{{ __('register.Mobile Number') }}"  class="mb-2 float-right" style="direction: rtl;"  />
...
--}}{{--                <x-jet-input id="mobile" class="block mt-1 w-full" type="tel" name="mobile" :value="old('mobile')"  />--}}{{--
            ...
            <div class="block mt-4">
                <label for="policy_procedure" class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600" style="padding-right: 10px;">{{ __('register.I agree')}}</span> <a href="{{route('arabic.policyProcedure.eula')}}" target="_blank" class="ml-2 text-sm text-red-600"><u>{{ __('register.Policy and Procedures') }}</u></a>
                </label>
            </div>
