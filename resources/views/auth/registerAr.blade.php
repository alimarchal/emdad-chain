<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <a href="{{route('arabic.index')}}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150" style="border-radius: 25px;margin-top: 15px">
                {{ __('sidebar.Home') }}
            </a>
        </x-slot>
            ...
            <div class="flex flex-wrap  lg:-mx-2 xl:-mx-2">
                ...
                <div class="w-full overflow-hidden lg:my-1 lg:px-1 lg:w-1/3 xl:my-1 xl:px-1 xl:w-1/3">
                    <label class="block font-medium text-sm text-gray-700 mb-2" for="gender">
                        {{ __('register.Title') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div class="w-full overflow-hidden lg:my-1 lg:px-1 lg:w-1/3 xl:my-1 xl:px-1 xl:w-1/3">
                    <label class="block font-medium text-sm text-gray-700" for="name">
                        {{ __('register.First Name') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div class="w-full overflow-hidden lg:my-1 lg:px-1 lg:w-1/3 xl:my-1 xl:px-1 xl:w-1/3">
                    <label class="block font-medium text-sm text-gray-700" for="family_name">
                        {{ __('register.Family Name') }} <span class="text-red-500">*</span>
                    </label>
            ...
            <div class="flex flex-wrap  lg:-mx-2 xl:-mx-2">
                ...
                <div class="w-full overflow-hidden lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
                    <label class="block font-medium text-sm text-gray-700" for="email">
                        {{ __('register.Email') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div class="w-full overflow-hidden lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
                    <div x-data="{ show: true }">
                        <label class="block font-medium text-sm text-gray-700" for="password">
                            {{ __('register.Password') }} <span class="text-red-500">*</span>
                        </label>
                        <div class="relative">
                ...
                <div class="w-full overflow-hidden lg:my-2 lg:px-2 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
                    <div x-data="{ show: true }">
                        <label class="block font-medium text-sm text-gray-700" for="password_confirmation">
                            {{ __('register.Confirm Password') }} <span class="text-red-500">*</span>
                        </label>
                        <div x-data="{ show: true }">
                            <div class="relative">
