            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mt-4">
                    <div class="py-2" x-data="{ show: true }">
                        ...
                        <div class="relative">
                            <input id="password" name="password" required autocomplete="current-password" :type="show ? 'password' : 'text'" class="form-input rounded-md shadow-sm block mt-1 w-full border border-gray-200">
                ...
                <div class="flex items-center mt-4" style="margin: auto;width: 50%; padding: 10px;">
                    <span class="ml-2 text-lg text-gray-600">{{ __('login.Not a member?') }}</span>
                    &nbsp;
