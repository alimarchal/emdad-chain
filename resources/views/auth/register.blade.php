    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex flex-wrap -mx-2 overflow-hidden sm:-mx-2 md:-mx-1 lg:-mx-3 xl:-mx-2">
                ...
                <div class="my-0  px-2 w-full overflow-hidden  pb-2 sm:my-2 sm:px-2 md:my-1 md:px-1 md:w-full lg:my-3 lg:px-3 lg:w-1/4 xl:my-2 xl:px-2 xl:w-1/4">
                ...
                <div class="my-0  px-2 w-full overflow-hidden  pb-2 sm:my-2 sm:px-2 md:my-1 md:px-1 md:w-full lg:my-3 lg:px-3 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3 ">
                ...
                <div class="mmy-0  px-2 w-full overflow-hidden  pb-2 sm:my-2 sm:px-2 md:my-1 md:px-1 md:w-full lg:my-3 lg:px-3 lg:w-1/3 xl:my-2 xl:px-2 xl:w-1/3">
                    <!-- Column Content -->
            ...
            <div class="mt-4">
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <label for="terms-and-privacy" class="ml-2 block text-sm text-gray-900">I agree to the <a href="#" class="text-indigo-600 hover:text-indigo-500">terms-and-privacy</a>
                        and <a href="#" class="text-indigo-600 hover:text-indigo-500">terms-and-privacy</a>
                    </label>
                </div>
                <div class="flex items-center justify-end mt-4">
