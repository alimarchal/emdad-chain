    ...
    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <nav class="mt-10">
            ...
            @if(auth()->user()->can('all') || auth()->user()->hasRole('Sales Specialist') || auth()->user()->hasRole('Legal Approval Officer 1') || auth()->user()->hasRole('Finance Officer 1') || auth()->user()->hasRole('SC Supervisor') || auth()->user()->hasRole('SC Specialist') || auth()->user()->hasRole('IT Admin'))
                ...
                @if(!auth()->user()->hasRole('Finance Officer 1'))
                    <a class="flex items-center mt-4 py-2 px-6  {{ request()->routeIs('category.index') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}   hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                       href="{{ route('category.create') }}">
                        ...
                        <span class="mx-3">  {{ __('navigation-dropdown.Categories Admin') }}</span>
                    </a>
                @endif
            ...
            {{-- RFQs link for Buyer --}}
            @if((auth()->user()->can('Buyer Create New RFQ') || auth()->user()->hasRole('CEO')) && auth()->user()->registration_type == 'Buyer')
            ...
            @if((auth()->user()->can('Supplier View New RFQs')|| auth()->user()->hasRole('CEO')) && auth()->user()->registration_type == 'Supplier' && Auth::user()->status == 3 && auth()->user()->business->status == 3)
                ...
                <div x-data="{ open: false } ">
                    <a @click="open = true" class="flex items-center mt-4 py-2 px-6
                            {{ request()->routeIs('viewRFQs') || request()->routeIs('QoutedRFQQouted') || request()->routeIs('QoutedRFQModificationNeeded') ||
                            request()->routeIs('QoutedRFQPendingConfirmation') || request()->routeIs('QoutedRFQQoutedExpired') ||
                            request()->routeIs('singleCategoryRFQs') || request()->routeIs('singleCategoryQuotedRFQQuoted')||
                            request()->routeIs('singleCategoryQuotedRFQRejected')|| request()->routeIs('singleCategoryQuotedRFQModificationNeeded')||
                            request()->routeIs('singleCategoryQuotedRFQPendingConfirmation') || request()->routeIs('singleCategoryQuotedModifiedRFQ') ||
                            request()->routeIs('singleCategoryRFQExpired') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}
                    ...
                    >
                        ...
                        @endphp
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('viewRFQs') || request()->routeIs('QoutedRFQQouted') || request()->routeIs('QoutedRFQModificationNeeded') || request()->routeIs('QoutedRFQPendingConfirmation') || request()->routeIs('QoutedRFQQoutedExpired') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11.611,10.049l-4.76-4.873c-0.303-0.31-0.297-0.804,0.012-1.105c0.309-0.304,0.803-0.293,1.105,0.012l5.306,5.433c0.304,0.31,0.296,0.805-0.012,1.105L7.83,15.928c-0.152,0.148-0.35,0.223-0.547,0.223c-0.203,0-0.406-0.08-0.559-0.236c-0.303-0.309-0.295-0.803,0.012-1.104L11.611,10.049z"></path>
                            </svg>
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('singleCategoryRFQs') ||request()->routeIs('singleCategoryQuotedRFQQuoted') ||request()->routeIs('singleCategoryQuotedRFQRejected') ||request()->routeIs('singleCategoryQuotedRFQModificationNeeded') ||request()->routeIs('singleCategoryQuotedRFQPendingConfirmation') ||request()->routeIs('singleCategoryQuotedModifiedRFQ') || request()->routeIs('singleCategoryRFQExpired') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11.611,10.049l-4.76-4.873c-0.303-0.31-0.297-0.804,0.012-1.105c0.309-0.304,0.803-0.293,1.105,0.012l5.306,5.433c0.304,0.31,0.296,0.805-0.012,1.105L7.83,15.928c-0.152,0.148-0.35,0.223-0.547,0.223c-0.203,0-0.406-0.08-0.559-0.236c-0.303-0.309-0.295-0.803,0.012-1.104L11.611,10.049z"></path>
                            </svg>
            ...
            @if((auth()->user()->can('Buyer View Quotations') || auth()->user()->hasRole('CEO')) && auth()->user()->registration_type == 'Buyer')
...
--}}{{--                        @if(request()->routeIs('QoutationsBuyerReceived') || request()->routeIs('singleCategoryBuyerRFQs') || request()->routeIs('singleCategoryRFQItems') || request()->routeIs('singleCategoryRFQQuotationsBuyerReceived') || request()->routeIs('singleCategoryRFQQuotationsBuyerRejected') || request()->routeIs('singleCategoryRFQQuotationsModificationNeeded'))  x-data="{ open: true } " @endif--}}{{--
                ...
                <div x-data="{ open: false } ">
                    <a @click="open = true"
                       ...
                       href="javascript:void(0);">
                        ...
                        <span x-show="open == false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" @if(auth()->user()->registration_type == "Supplier") style="margin-left: 0.8em;" @else style="margin-left: 0.7em;" @endif  viewBox="0 0 20 20" fill="currentColor">
                          <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                    </span>
                        <span x-show="open == true">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ml-12 w-4 h-4" @if(auth()->user()->registration_type == "Supplier") style="margin-left: 0.8em;" @else style="margin-left: 0.8em;" @endif viewBox="0 0 20 20"
                             fill="currentColor">
                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
                        </svg>
                    </span>
                    ...
                    <ul
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('purchaseOrderView') || request()->routeIs('po.po') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            ...
                            <a href="{{ route('po.po') }}"> <span class="ml-1">{{__('portal.PO(s)')}}</span> </a>
                        </li>
            ...
            @if(auth()->user()->hasRole('CEO|Buyer Payment Admin') && auth()->user()->registration_type == 'Buyer' && Auth::user()->status == 3 && auth()->user()->business->status == 3)
                ...
                {{--<div x-data="{ open: false } ">
                    <a @click="open = true"
                       class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('invoices') || request()->routeIs('bank-payments.index') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                       href="javascript:void(0);">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fill="none"
                                  d="M5.229,6.531H4.362c-0.239,0-0.434,0.193-0.434,0.434c0,0.239,0.194,0.434,0.434,0.434h0.868c0.24,0,0.434-0.194,0.434-0.434C5.663,6.724,5.469,6.531,5.229,6.531 M10,6.531c-1.916,0-3.47,1.554-3.47,3.47c0,1.916,1.554,3.47,3.47,3.47c1.916,0,3.47-1.555,3.47-3.47C13.47,8.084,11.916,6.531,10,6.531 M11.4,11.447c-0.071,0.164-0.169,0.299-0.294,0.406c-0.124,0.109-0.27,0.191-0.437,0.248c-0.167,0.057-0.298,0.09-0.492,0.098v0.402h-0.35v-0.402c-0.21-0.004-0.352-0.039-0.527-0.1c-0.175-0.064-0.324-0.154-0.449-0.27c-0.124-0.115-0.221-0.258-0.288-0.428c-0.068-0.17-0.1-0.363-0.096-0.583h0.664c-0.004,0.259,0.052,0.464,0.169,0.613c0.116,0.15,0.259,0.229,0.527,0.236v-1.427c-0.159-0.043-0.268-0.095-0.425-0.156c-0.157-0.061-0.299-0.139-0.425-0.235C8.852,9.752,8.75,9.631,8.672,9.486C8.594,9.34,8.556,9.16,8.556,8.944c0-0.189,0.036-0.355,0.108-0.498c0.072-0.144,0.169-0.264,0.292-0.36c0.122-0.097,0.263-0.17,0.422-0.221c0.159-0.052,0.277-0.077,0.451-0.077V7.401h0.35v0.387c0.174,0,0.29,0.023,0.445,0.071c0.155,0.047,0.29,0.118,0.404,0.212c0.115,0.095,0.206,0.215,0.274,0.359c0.067,0.146,0.103,0.315,0.103,0.508H10.74c-0.007-0.201-0.06-0.354-0.154-0.46c-0.096-0.106-0.199-0.159-0.408-0.159v1.244c0.174,0.047,0.296,0.102,0.462,0.165c0.167,0.063,0.314,0.144,0.443,0.241c0.128,0.099,0.23,0.221,0.309,0.366c0.077,0.146,0.116,0.324,0.116,0.536C11.509,11.092,11.473,11.283,11.4,11.447 M18.675,4.795H1.326c-0.479,0-0.868,0.389-0.868,0.868v8.674c0,0.479,0.389,0.867,0.868,0.867h17.349c0.479,0,0.867-0.389,0.867-0.867V5.664C19.542,5.184,19.153,4.795,18.675,4.795M1.76,5.664c0.24,0,0.434,0.193,0.434,0.434C2.193,6.336,2,6.531,1.76,6.531S1.326,6.336,1.326,6.097C1.326,5.857,1.52,5.664,1.76,5.664 M1.76,14.338c-0.24,0-0.434-0.195-0.434-0.434c0-0.24,0.194-0.434,0.434-0.434s0.434,0.193,0.434,0.434C2.193,14.143,2,14.338,1.76,14.338 M18.241,14.338c-0.24,0-0.435-0.195-0.435-0.434c0-0.24,0.194-0.434,0.435-0.434c0.239,0,0.434,0.193,0.434,0.434C18.675,14.143,18.48,14.338,18.241,14.338 M18.675,12.682c-0.137-0.049-0.281-0.08-0.434-0.08c-0.719,0-1.302,0.584-1.302,1.303c0,0.152,0.031,0.297,0.08,0.434H2.981c0.048-0.137,0.08-0.281,0.08-0.434c0-0.719-0.583-1.303-1.301-1.303c-0.153,0-0.297,0.031-0.434,0.08V7.318c0.136,0.049,0.28,0.08,0.434,0.08c0.718,0,1.301-0.583,1.301-1.301c0-0.153-0.032-0.298-0.08-0.434H17.02c-0.049,0.136-0.08,0.28-0.08,0.434c0,0.718,0.583,1.301,1.302,1.301c0.152,0,0.297-0.031,0.434-0.08V12.682z M18.241,6.531c-0.24,0-0.435-0.194-0.435-0.434c0-0.24,0.194-0.434,0.435-0.434c0.239,0,0.434,0.193,0.434,0.434C18.675,6.336,18.48,6.531,18.241,6.531 M9.22,8.896c0,0.095,0.019,0.175,0.058,0.242c0.039,0.066,0.088,0.124,0.148,0.171c0.061,0.047,0.13,0.086,0.21,0.115c0.079,0.028,0.11,0.055,0.192,0.073V8.319c-0.21,0-0.322,0.044-0.437,0.132C9.277,8.54,9.22,8.688,9.22,8.896 M15.639,12.602h-0.868c-0.239,0-0.434,0.195-0.434,0.434c0,0.24,0.194,0.436,0.434,0.436h0.868c0.24,0,0.434-0.195,0.434-0.436C16.072,12.797,15.879,12.602,15.639,12.602 M10.621,10.5c-0.068-0.052-0.145-0.093-0.23-0.124c-0.086-0.031-0.123-0.06-0.212-0.082v1.374c0.209-0.016,0.332-0.076,0.465-0.186c0.134-0.107,0.201-0.281,0.201-0.516c0-0.11-0.02-0.202-0.062-0.277C10.743,10.615,10.688,10.551,10.621,10.5"></path>
                        </svg>
                        <span class="mx-3 font-extrabold"> {{ __('sidebar.Payments') }} </span>
                        <span x-show="open == false">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" style="margin-left: 3.7em;" viewBox="0 0 20 20" fill="currentColor">
                              <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                        </span>
                        <span x-show="open == true">
                            <svg xmlns="http://www.w3.org/2000/svg" class="ml-12 w-4 h-4" style="margin-left: 3.7em;" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
                            </svg>
                        </span>
                    </a>
                    ...
                    <ul
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('invoices') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            ...
                            <a href="{{ route('invoices') }}"> <span class="ml-1 ">{{__('portal.Invoices History')}}</span> </a>
                        </li>
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('bank-payments.index') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            ...
                            <a href="{{ route('bank-payments.index') }}"> <span class="ml-1">{{__('portal.Unpaid Invoices')}}</span> </a>
                        </li>

                    </ul>
                </div>--}}

                {{-- Commented above and added below because invoices history and unpaid invoices views are merged into one view --}}
                <a class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('invoices') || request()->routeIs('bank-payments.index') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                   href="{{ route('invoices') }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path fill="none"
                              d="M5.229,6.531H4.362c-0.239,0-0.434,0.193-0.434,0.434c0,0.239,0.194,0.434,0.434,0.434h0.868c0.24,0,0.434-0.194,0.434-0.434C5.663,6.724,5.469,6.531,5.229,6.531 M10,6.531c-1.916,0-3.47,1.554-3.47,3.47c0,1.916,1.554,3.47,3.47,3.47c1.916,0,3.47-1.555,3.47-3.47C13.47,8.084,11.916,6.531,10,6.531 M11.4,11.447c-0.071,0.164-0.169,0.299-0.294,0.406c-0.124,0.109-0.27,0.191-0.437,0.248c-0.167,0.057-0.298,0.09-0.492,0.098v0.402h-0.35v-0.402c-0.21-0.004-0.352-0.039-0.527-0.1c-0.175-0.064-0.324-0.154-0.449-0.27c-0.124-0.115-0.221-0.258-0.288-0.428c-0.068-0.17-0.1-0.363-0.096-0.583h0.664c-0.004,0.259,0.052,0.464,0.169,0.613c0.116,0.15,0.259,0.229,0.527,0.236v-1.427c-0.159-0.043-0.268-0.095-0.425-0.156c-0.157-0.061-0.299-0.139-0.425-0.235C8.852,9.752,8.75,9.631,8.672,9.486C8.594,9.34,8.556,9.16,8.556,8.944c0-0.189,0.036-0.355,0.108-0.498c0.072-0.144,0.169-0.264,0.292-0.36c0.122-0.097,0.263-0.17,0.422-0.221c0.159-0.052,0.277-0.077,0.451-0.077V7.401h0.35v0.387c0.174,0,0.29,0.023,0.445,0.071c0.155,0.047,0.29,0.118,0.404,0.212c0.115,0.095,0.206,0.215,0.274,0.359c0.067,0.146,0.103,0.315,0.103,0.508H10.74c-0.007-0.201-0.06-0.354-0.154-0.46c-0.096-0.106-0.199-0.159-0.408-0.159v1.244c0.174,0.047,0.296,0.102,0.462,0.165c0.167,0.063,0.314,0.144,0.443,0.241c0.128,0.099,0.23,0.221,0.309,0.366c0.077,0.146,0.116,0.324,0.116,0.536C11.509,11.092,11.473,11.283,11.4,11.447 M18.675,4.795H1.326c-0.479,0-0.868,0.389-0.868,0.868v8.674c0,0.479,0.389,0.867,0.868,0.867h17.349c0.479,0,0.867-0.389,0.867-0.867V5.664C19.542,5.184,19.153,4.795,18.675,4.795M1.76,5.664c0.24,0,0.434,0.193,0.434,0.434C2.193,6.336,2,6.531,1.76,6.531S1.326,6.336,1.326,6.097C1.326,5.857,1.52,5.664,1.76,5.664 M1.76,14.338c-0.24,0-0.434-0.195-0.434-0.434c0-0.24,0.194-0.434,0.434-0.434s0.434,0.193,0.434,0.434C2.193,14.143,2,14.338,1.76,14.338 M18.241,14.338c-0.24,0-0.435-0.195-0.435-0.434c0-0.24,0.194-0.434,0.435-0.434c0.239,0,0.434,0.193,0.434,0.434C18.675,14.143,18.48,14.338,18.241,14.338 M18.675,12.682c-0.137-0.049-0.281-0.08-0.434-0.08c-0.719,0-1.302,0.584-1.302,1.303c0,0.152,0.031,0.297,0.08,0.434H2.981c0.048-0.137,0.08-0.281,0.08-0.434c0-0.719-0.583-1.303-1.301-1.303c-0.153,0-0.297,0.031-0.434,0.08V7.318c0.136,0.049,0.28,0.08,0.434,0.08c0.718,0,1.301-0.583,1.301-1.301c0-0.153-0.032-0.298-0.08-0.434H17.02c-0.049,0.136-0.08,0.28-0.08,0.434c0,0.718,0.583,1.301,1.302,1.301c0.152,0,0.297-0.031,0.434-0.08V12.682z M18.241,6.531c-0.24,0-0.435-0.194-0.435-0.434c0-0.24,0.194-0.434,0.435-0.434c0.239,0,0.434,0.193,0.434,0.434C18.675,6.336,18.48,6.531,18.241,6.531 M9.22,8.896c0,0.095,0.019,0.175,0.058,0.242c0.039,0.066,0.088,0.124,0.148,0.171c0.061,0.047,0.13,0.086,0.21,0.115c0.079,0.028,0.11,0.055,0.192,0.073V8.319c-0.21,0-0.322,0.044-0.437,0.132C9.277,8.54,9.22,8.688,9.22,8.896 M15.639,12.602h-0.868c-0.239,0-0.434,0.195-0.434,0.434c0,0.24,0.194,0.436,0.434,0.436h0.868c0.24,0,0.434-0.195,0.434-0.436C16.072,12.797,15.879,12.602,15.639,12.602 M10.621,10.5c-0.068-0.052-0.145-0.093-0.23-0.124c-0.086-0.031-0.123-0.06-0.212-0.082v1.374c0.209-0.016,0.332-0.076,0.465-0.186c0.134-0.107,0.201-0.281,0.201-0.516c0-0.11-0.02-0.202-0.062-0.277C10.743,10.615,10.688,10.551,10.621,10.5"></path>
                    </svg>
                    <span class="mx-3">{{ __('sidebar.Invoices') }}</span>
                </a>
            @endif
                ...
                <div x-data="{ open: false } ">
                    <a @click="open = true"
                       ...
                       href="javascript:void(0);">
                        ...
                        <span x-show="open == true">
                            <svg xmlns="http://www.w3.org/2000/svg" class="ml-12 w-4 h-4" style="margin-left: 3.0em;" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
                            </svg>
                        </span>
                    </a>
...
{{--                                @if (isset($isBusinessWarehouseDataExist)) &nbsp;<img src="{{ url('complete_check.jpg') }}" class="w-4 inline"> @endif--}}
            ...
            <a class="flex items-center mt-4 py-2 px-6  {{ request()->routeIs('showLibrary') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}   hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
               href="{{route('showLibrary')}}" style="color: yellow">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-6"  fill="none" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet" stroke="currentColor" >
                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                       fill="currentColor" stroke="none">
                        <path d="M2520 5113 c-8 -4 -103 -70 -210 -148 -1558 -1130 -2130 -1545 -2161 -1570 -57 -45 -65 -107 -20 -157 l29 -33 2400 0 2400 0 26 24 c49 46 43 131 -13 167 -14 10 -548 396 -1186 859 -638 463 -1170 847 -1182 853 -23 13 -58 14 -83 5z m623 -656 c320 -233 764 -555 987 -716 223 -162 414 -302 425 -312 19 -19 -30 -19 -2000 -19 l-2020 1 29 22 c57 42 1991 1447 1994 1447 1 0 264 -190 585 -423z"/>
                        <path d="M1860 3003 c-210 -23 -410 -97 -457 -170 -17 -25 -18 -86 -21 -943 -2 -614 0 -927 7 -951 14 -47 40 -69 89 -76 34 -5 49 0 99 31 117 72 247 101 448 100 195 0 338 -33 436 -101 63 -43 105 -51 153 -28 20 10 36 22 36 27 0 15 105 57 199 80 68 17 118 22 236 22 195 1 286 -18 420 -84 120 -60 145 -62 191 -16 l34 34 0 939 c-1 717 -4 943 -13 960 -60 107 -394 196 -671 179 -180 -11 -309 -38 -418 -88 l-67 -30 -73 30 c-88 36 -161 57 -248 72 -67 11 -318 20 -380 13z m432 -241 c42 -12 95 -30 117 -42 l41 -20 0 -505 c0 -303 4 -514 10 -529 11 -30 65 -66 97 -66 34 0 71 20 90 49 17 24 18 68 20 536 2 281 3 513 3 516 0 13 145 60 234 75 126 22 391 15 491 -14 39 -11 82 -24 98 -30 l27 -12 0 -785 c0 -432 -3 -785 -8 -785 -4 0 -52 12 -107 27 -93 25 -115 27 -305 27 -228 1 -304 -12 -466 -77 l-80 -33 -62 28 c-34 16 -106 40 -159 55 -92 25 -110 27 -313 27 -203 0 -221 -2 -313 -27 -53 -15 -99 -27 -102 -27 -3 0 -4 354 -3 787 l3 787 49 18 c98 37 192 48 381 44 142 -3 196 -8 257 -24z"/>
                        <path d="M384 2976 c-69 -30 -64 46 -64 -1056 0 -904 1 -998 16 -1019 34 -48 60 -51 411 -51 292 0 332 2 363 18 19 9 40 28 47 42 18 36 18 1984 0 2020 -7 14 -28 33 -47 42 -31 16 -70 18 -365 18 -255 -1 -337 -4 -361 -14z m576 -1056 l0 -850 -215 0 -215 0 0 850 0 850 215 0 215 0 0 -850z"/>
                        <path d="M4015 2980 c-11 -4 -31 -20 -45 -35 l-25 -27 0 -999 0 -999 33 -32 32 -33 345 -3 c389 -3 404 -1 430 62 22 53 22 1959 0 2012 -26 62 -42 64 -417 63 -183 0 -342 -4 -353 -9z m565 -1060 l0 -850 -210 0 -210 0 0 850 0 850 210 0 210 0 0 -850z"/>
                        <path d="M153 621 c-21 -13 -35 -32 -42 -56 -12 -46 -12 -444 0 -490 7 -24 21 -43 42 -55 31 -20 72 -20 2410 -20 l2379 0 34 34 34 34 0 251 0 251 -29 32 -29 33 -2384 2 c-2346 3 -2383 3 -2415 -16z m4647 -301 l0 -110 -2240 0 -2240 0 0 110 0 110 2240 0 2240 0 0 -110z"/>
                    </g>
                </svg>
                ...
                {{--<div x-data="{ open: false } ">
                    <a @click="open = true"
                       ...
                       href="javascript:void(0);">
                        ...
                        <span class="mx-3 font-extrabold"> {{ __('sidebar.RFQs') }} </span>
                        <span x-show="open == false">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" style="margin-left: 2.5em;transform: scaleX(-1)" viewBox="0 0 20 20" fill="currentColor">
                                  <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                </svg>
                            </span>
                        <span x-show="open == true">
                                <svg xmlns="http://www.w3.org/2000/svg" class="ml-12 w-4 h-4" style="margin-left: 2.5em;transform: scaleX(-1)" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                </svg>
                            </span>
                    </a>
                    ...
                    <ul
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('rfqView') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" style="transform: scaleX(-1)" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11.611,10.049l-4.76-4.873c-0.303-0.31-0.297-0.804,0.012-1.105c0.309-0.304,0.803-0.293,1.105,0.012l5.306,5.433c0.304,0.31,0.296,0.805-0.012,1.105L7.83,15.928c-0.152,0.148-0.35,0.223-0.547,0.223c-0.203,0-0.406-0.08-0.559-0.236c-0.303-0.309-0.295-0.803,0.012-1.104L11.611,10.049z"></path>
                            </svg>

                            <a href="{{ route('rfqView') }}"> <span class="mx-3 hover:text-white {{ request()->routeIs('rfqView') ? 'text-white' : 'text-gray-500' }}">{{__('portal.New Requisition')}}</span> </a>
                        </li>
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('PlacedRFQ.index') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            ...
                            <a href="{{ route('PlacedRFQ.index') }}"> <span class="mx-3 hover:text-white {{ request()->routeIs('PlacedRFQ.index') ? 'text-white' : 'text-gray-500' }}">{{__('portal.Requisitions History')}}</span> </a>
                        </li>
                ...
                <div x-data="{ open: false } ">
                    ...
                    >
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('viewRFQs') || request()->routeIs('QoutedRFQQouted') || request()->routeIs('QoutedRFQModificationNeeded') || request()->routeIs('QoutedRFQPendingConfirmation') || request()->routeIs('QoutedRFQQoutedExpired') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            ...
                            <a href="{{ route('viewRFQs') }}"><span class="mx-3 hover:text-white {{ request()->routeIs('viewRFQs') || request()->routeIs('QoutedRFQQouted') || request()->routeIs('QoutedRFQModificationNeeded') || request()->routeIs('QoutedRFQPendingConfirmation') || request()->routeIs('QoutedRFQQoutedExpired') ? 'text-white' : 'text-gray-500' }}">{{ __('sidebar.Multi categories') }} ({{count($noMultiCategoryQuotationPresent)}})</span></a>
                        </li>
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('singleCategoryRFQs') ||request()->routeIs('singleCategoryQuotedRFQQuoted') ||request()->routeIs('singleCategoryQuotedRFQRejected') ||request()->routeIs('singleCategoryQuotedRFQModificationNeeded') ||request()->routeIs('singleCategoryQuotedRFQPendingConfirmation') ||request()->routeIs('singleCategoryQuotedModifiedRFQ') || request()->routeIs('singleCategoryRFQExpired') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <a href="{{ route('singleCategoryRFQs') }}"><span
                                    class="mx-3 hover:text-white {{ request()->routeIs('singleCategoryRFQs') ||request()->routeIs('singleCategoryQuotedRFQQuoted') ||request()->routeIs('singleCategoryQuotedRFQRejected') ||request()->routeIs('singleCategoryQuotedRFQModificationNeeded') ||request()->routeIs('singleCategoryQuotedRFQPendingConfirmation') ||request()->routeIs('singleCategoryQuotedModifiedRFQ') || request()->routeIs('singleCategoryRFQExpired') ? 'text-white' : 'text-gray-500' }}">{{ __('sidebar.Single category') }} @if(count($eOrders) > 0 && count($quotesNotPresent) > 0)
                ...
                <div x-data="{ open: false } ">
                    ...
                    >
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('po.po') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            ...
                            <a href="{{ route('po.po') }}"> <span class="mx-3 hover:text-white {{ request()->routeIs('po.po') ? 'text-white' : 'text-gray-500' }}">{{__('portal.PO(s)')}}</span> </a>
                        </li>
            ...
            @if(auth()->user()->hasRole('CEO|Buyer Payment Admin') && auth()->user()->registration_type == 'Buyer' && Auth::user()->status == 3 && auth()->user()->business->status == 3)
                ...
                {{--<div x-data="{ open: false } ">
                    ...
                    <ul
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('invoices') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" style="transform: scaleX(-1)">
                                <path
                                    d="M11.611,10.049l-4.76-4.873c-0.303-0.31-0.297-0.804,0.012-1.105c0.309-0.304,0.803-0.293,1.105,0.012l5.306,5.433c0.304,0.31,0.296,0.805-0.012,1.105L7.83,15.928c-0.152,0.148-0.35,0.223-0.547,0.223c-0.203,0-0.406-0.08-0.559-0.236c-0.303-0.309-0.295-0.803,0.012-1.104L11.611,10.049z"></path>
                            </svg>

                            <a href="{{ route('invoices') }}"> <span class="mx-3 hover:text-white {{ request()->routeIs('invoices') ? 'text-white' : 'text-gray-500' }} ">{{__('portal.Invoices History')}}</span> </a>
                        </li>
                        ...
                        <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('bank-payments.index') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                            ...
                            <a href="{{ route('bank-payments.index') }}"> <span class="mx-3 hover:text-white {{ request()->routeIs('bank-payments.index') ? 'text-white' : 'text-gray-500' }}">{{__('portal.Unpaid Invoices')}}</span> </a>
                        </li>
