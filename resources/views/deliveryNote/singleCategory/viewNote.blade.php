                    ...
                    <div class="px-4 py-5 sm:p-6 bg-white shadow ">
                        ...
                        <div class="flex flex-wrap overflow-hidden bg-white p-4">
                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-2/3">
                                <strong>{{__('portal.Delivery Note')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.D.N.')}}-{{ $deliveryNotes[0]->id }}<br>
                                @if ($deliveryNotes[0]->status == 'completed')
                                    <strong>{{__('portal.Invoice')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.Inv.')}}-{{ $deliveryNotes[0]->delivery->invoice_id }}<br>
                                @endif
                                <strong>{{__('portal.Purchase Order')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.PO')}}-{{ $deliveryNotes[0]->purchase_order->id }}<br>
            ...
            <div class="max-w-7xl mx-auto sm:px-2 lg:2x-8">
                <div class="bg-white overflow-hidden shadow-xl ">
                    <div class="px-4 py-5 sm:p-6 bg-white shadow ">
                        ...
                        <div class="flex flex-wrap overflow-hidden bg-white p-4">
                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-2/3">
                                <strong>{{__('portal.Delivery Note')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.D.N.')}}-<span style="font-family: sans-serif">{{ $deliveryNotes[0]->id }}</span> <br>
                                @if ($deliveryNotes[0]->status == 'completed')
                                    <strong>{{__('portal.Invoice')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.Inv.')}}-<span style="font-family: sans-serif">{{ $deliveryNotes[0]->delivery->invoice_id }}</span> <br>
                                @endif
                                <strong>{{__('portal.Purchase Order')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.PO')}}-<span style="font-family: sans-serif">{{ $deliveryNotes[0]->purchase_order->id }}</span> <br>
                                <strong>{{__('portal.Category Name')}}: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                @php
                                    $record = \App\Models\Category::where('id',$deliveryNotes[0]->purchase_order->item_code)->first();
                                    $parent= \App\Models\Category::where('id',$record->parent_id)->first();
                                ...
                                <br>
                                <strong>{{__('portal.Date')}}: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><span style="font-family: sans-serif">{{ $deliveryNotes[0]->purchase_order->created_at }}</span> <br>
                                <strong>{{__('portal.Requisition')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.RFQ')}}-<span style="font-family: sans-serif">{{ $deliveryNotes[0]->purchase_order->rfq_no }}</span> <br>
                                <strong>{{__('portal.Quote')}} #: &nbsp;&nbsp;</strong>{{__('portal.Q')}}-<span style="font-family: sans-serif">{{ $deliveryNotes[0]->purchase_order->qoute_no }}</span> <br>
                                <strong>{{__('portal.Payment Terms')}} : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                @if($deliveryNotes[0]->purchase_order->payment_term == 'Cash') {{__('portal.Cash')}}
                                @elseif($deliveryNotes[0]->purchase_order->payment_term == 'Credit') {{__('portal.Credit')}}
                                @elseif($deliveryNotes[0]->purchase_order->payment_term == 'Credit30days') {{__('portal.Credit (30 Days)')}}
                        ...
                        @if ($deliveryNotes[0]->status == 'processing')
                            <h2 class="text-2xl text-center font-bold">{{__('portal.Invoice Generate')}}</h2>
                            <p>
                                <strong>{{__('portal.Delivery Address')}}:</strong> <span style="font-family: sans-serif">{{ $deliveryNotes[0]->delivery_address }}</span> <br>
                                <strong>{{__('portal.City')}}:</strong> <span style="font-family: sans-serif">{{ $deliveryNotes[0]->city }}</span> <br>
                                @if(isset($deliveryNotes[0]->terms_and_conditions)) <strong>{{__('portal.Terms and Conditions')}}:</strong> <span style="font-family: sans-serif">{{ $deliveryNotes[0]->terms_and_conditions }}</span> <br> @endif
                                @if(isset($deliveryNotes[0]->warranty)) <strong>{{__('portal.Warranty')}}:</strong> <span style="font-family: sans-serif">{{ $deliveryNotes[0]->warranty }}</span> <br> @endif
                            </p>
