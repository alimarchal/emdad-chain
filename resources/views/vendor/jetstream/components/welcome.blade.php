<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    @if(Auth::user()->profile_approved)
        <div class="mt-6 text-red-500 text-2xl">
            Thanks for signing up! Before getting started, your emails address has been verified. But your profile approval is
            pending on our end our team will once verify your account it will take around 24hr to 72hrs please wait patiently.
        </div>
    @endif
</div>
