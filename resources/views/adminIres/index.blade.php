                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="py-3">
                       {{-- <div class="mt-5" style=" margin-left: 30px; margin-bottom: 10px ">
                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <h2 class="text-2xl font-bold text-center">{{__('portal.IREs List')}}</h2>
                                                            ...
                                                            <tr>
                                                                        ...
                                                                        <div class="text-sm font-medium text-gray-900">
                                                                            {{ $ire->email }}
                                                                                                                       ...
                                                                                                                       {{-- <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                                                                                                            <div class="ml-4">
                                                                                                                                <div class="text-sm font-medium text-gray-900">
                                                                                                                                    @php $referencedUsers = \App\Models\IreCommission::where('ire_no', $ire->ire_no)->get(); @endphp

                                                                                                                                    @if(isset($referencedUsers))
                                                                                                                                        @foreach($referencedUsers as $referencedUser )
                                                                                                                                            {{$referencedUser->user_id }}
                                                                ...
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100  text-red-800">
                                                                        @php $bankName = \App\Models\Bank::where('id', $ire->bank)->first(); @endphp
                                                                        @if(isset($bankName)){{$bankName->name }} @else N/A @endif
                                                                    </span>
                                                                </td>
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                                                ...
                                                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                                    ...
                                                                    <form action="{{ route('adminIreEdit') }}" method="post" class="inline-block">
                                                                        @csrf
                                                        ...
                                                        @foreach ($ires as $ire)
                                                            <tr>
                                                                ...
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100  text-red-800">
                                                                            @php $bankName = \App\Models\Bank::where('id', $ire->bank)->first(); @endphp
                                                                            @if(isset($bankName)){{$bankName->ar_name }} @else N/A @endif
                                                                        </span>
                                                                </td>
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100  text-green-800">
