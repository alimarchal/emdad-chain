...
<main id="main">
    ...
    <section class="inner-page">
        <div class="container " style="direction: rtl;" data-aos="fade-up">
            ...
            <p><br>عزيزي صاحب المنشأة:</p>
            <p>
                حرصاً منا على تقديم خدمتنا بالمستوى الأفضل لكم تم عمل هذا الاستبيان تحدياً منا لرفع مستوى جودة سلاسل الامداد لديكم و خاصتاً في ظل الظروف الحالية لجائحة COVID 19 و سعياً منا لتحقيق رؤية
