            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="px-4 py-0 bg-white sm:p-6 rounded-sm">
                    ...
                    <form action="{{route('businessWarehouse.update', $businessWarehouse->id)}}" method="post" class="form bg-white p-6  mb-4" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @if($businessWarehouse->user->registration_type == 'Buyer')
                            <input type="hidden" name="registration_type" value="Buyer">
                        @elseif($businessWarehouse->user->registration_type == 'Supplier')
                            <input type="hidden" name="registration_type" value="Supplier">
                        @endif
                        ...
                        <div class="flex space-x-5 mt-3">
                            <select id="name" name="name" class="form-input rounded-md shadow-sm border p-2 w-1/2" required>
                                ...
                                @foreach(\App\Models\User::where('business_id', $businessWarehouse->business_id)->get() as $user)
                        ...
                        <div class="flex space-x-5 mt-3">
                            ...
                            @if($businessWarehouse->user->registration_type == 'Supplier')
