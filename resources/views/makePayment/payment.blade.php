<x-app-layout>
    ...
    <form action="{{route('processPaymentStatus')}}?invoice_id={{$invoice->id}}&merchant_id={{$merchant_id->id}}&gateway={{$gateway}}" method="get" class="paymentWidgets" data-brands="@if($gateway == "mada") MADA @else VISA MASTER @endif">
    </form>
