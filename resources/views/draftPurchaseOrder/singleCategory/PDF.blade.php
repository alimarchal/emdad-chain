...
<div class="header">
    ...
    <div style="width: 33.33%;float: right">
        ...
        <strong>Shipment cost: </strong> {{ number_format($draftPurchaseOrders[0]->shipment_cost, 2) }} SR<br>
        <strong>VAT {{ number_format($draftPurchaseOrders[0]->vat) }}%: </strong>{{ number_format(($subtotal + $draftPurchaseOrders[0]->shipment_cost) * ($draftPurchaseOrders[0]->vat/100), 2) }} SR<br>
        {{--        <strong>VAT: </strong> {{ number_format($draftPurchaseOrders[0]->vat)}} %<br>--}}
        <hr>
        <strong>Total: </strong> {{ number_format($draftPurchaseOrders[0]->total_cost, 2) }} SR<br>
        <hr>
        <br>
        <br>
        <br>
