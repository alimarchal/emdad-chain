                ...
                <div class="px-4 py-5 sm:p-6 bg-white shadow ">
                    ...
                    <div class="flex flex-wrap overflow-hidden bg-white p-4">
                        ...
                        <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3 ">
                            ...
                            <strong>D.P. O. #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>Emdad-{{ $draftPurchaseOrder->id }}<br>
                    ...
                    <div class="flex flex-wrap overflow-hidden bg-white p-4">
                        ...
                        <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3">
                            ...
                            <strong>VAT %: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ number_format($draftPurchaseOrder->sub_total * ($draftPurchaseOrder->vat/100), 2) }}<br>
                            <strong>Shipment cost: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ number_format($draftPurchaseOrder->shipment_cost, 2) }}<br>
                            <hr>
                            <strong>Total: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ number_format(($draftPurchaseOrder->sub_total + ($draftPurchaseOrder->sub_total * ($draftPurchaseOrder->vat/100) + $draftPurchaseOrder->shipment_cost)),2) }}<br>
                            <hr>
                        </div>
                    </div>
