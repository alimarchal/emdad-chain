                    ...
                    <div class="px-4 py-5 sm:p-6 bg-white shadow ">
                        ...
                        <div class="flex flex-wrap overflow-hidden bg-white p-4">
                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3">
                                ...
                                <strong>{{__('portal.ID')}}: </strong> {{ $draftPurchaseOrder->buyer_business->user_id }}<br>
                                <strong>{{__('portal.City')}}: </strong>{{ $draftPurchaseOrder->buyer_business->city }}<br>
                            </div>
                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3">
                                <strong>{{__('portal.Purchased From')}}: </strong><br>
                                <p>{{ $draftPurchaseOrder->supplier_business->business_name }}</p><br>

                                <strong>{{__('portal.ID')}}: </strong>{{ $draftPurchaseOrder->supplier_business->user_id }}<br>
                                <strong>{{__('portal.City')}}: </strong>{{ $draftPurchaseOrder->supplier_business->city }}<br>
                            </div>
                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3 ">
                                <h3 class="text-2xl text-center"><strong>{{__('portal.Purchase Order')}}</strong></h3>
                                <strong>{{__('portal.P.O.')}} #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{__('portal.Emdad')}}-{{ $draftPurchaseOrder->id }}<br>
...
{{--                                    {{ $draftPurchaseOrder->payment_term }}--}}
                        ...
                        <div class="flex flex-wrap overflow-hidden bg-white p-4">
                            ...
                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3">
                                ...
                                <strong>{{__('portal.VAT')}} %: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ number_format($draftPurchaseOrder->sub_total * 0.15, 2) }}<br>
                                <strong>{{__('portal.Shipment cost')}}: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ number_format($draftPurchaseOrder->shipment_cost, 2) }}<br>
                                <hr>
                                <strong>{{__('portal.Total')}}: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ number_format($draftPurchaseOrder->sub_total * 0.15 + $draftPurchaseOrder->sub_total + $draftPurchaseOrder->shipment_cost, 2) }}<br>
                                <hr>
                            </div>
                        </div>
