...
@endrole
        ...
        <div class="mt-4">
            <div class="flex flex-wrap -mx-6">
                ...
                <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                        <div class="p-3 rounded-full bg-pink-600 bg-opacity-75">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" @if(auth()->user()->rtl == 1) style="transform: scaleX(-1)" @endif>
                ...
                <div class="w-full mt-6 px-6 pt-3 sm:w-1/2 xl:w-1/3 xl:mt-0">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                        <div class="p-3 rounded-full bg-pink-600 bg-opacity-75">
                            ...
                            @else
                                <img style="transform: scaleX(-1)" class="w-6 h-6" src="https://img.icons8.com/glyph-neue/64/000000/truck.png"/>
                            @endif
                        </div>
    ...
    @elseif(Auth::user()->status == 3 && Auth::user()->registration_type == "Supplier")
