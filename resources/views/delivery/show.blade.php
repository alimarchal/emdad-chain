...
{{--                                        <h1 class="text-center text-2xl">{{ $deliveries[0]->buyer->business->business_name }}</h1>--}}
                                    ...
                                    <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3">
                                        <img class="h-20 w-20 rounded-full object-cover" style="margin: auto" src="{{ Storage::url($deliveries[0]->supplier->business->business_photo_url) }}" alt="{{ $deliveries[0]->supplier->business->business_name }}" />
