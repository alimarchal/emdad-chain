            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="px-4 py-0 bg-white sm:p-6 rounded-sm">
                    <form action="{{route('adminDownloadStore')}}" method="POST" class="form bg-white p-6  mb-4" enctype="multipart/form-data">
                        ...
                        <div class="flex space-x-5 mt-3">
                            <x-jet-input id="name_en" type="text" name="name_en" required class="border p-2 w-1/2" value="{{old('name_en')}}" required></x-jet-input>
                        ...
                        <div class="flex space-x-5 mt-3">
                            <x-jet-input id="icon" type="file" name="icon" class="border p-2 w-1/2" value=""></x-jet-input>
                            <x-jet-input id="file" type="file" name="file" class="border p-2 w-1/2" value=""></x-jet-input>
                        </div>
