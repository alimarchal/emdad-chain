    ...
    <nav class="mt-10">
        <a class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('sellerDashboard') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{ route('sellerDashboard') }}">
            ...
            {{-- References --}}
            <a class="flex items-center mt-4 py-2 px-6  {{ request()->routeIs('sellerReference') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}   hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="{{ route('sellerReference') }}">
