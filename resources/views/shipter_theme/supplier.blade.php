            ...
            <div class="pricing-area pricing-area-2">
                <div class="container">
                    ...
                    <div class="section-title text-center">
                        ...
                        <div class="btns">
                            <div class="btn-style btn-style-4"><a href="{{route('register')}}" style="border-radius: 25px;">Subscribe</a></div>
                        </div>
                        <a href="{{route('english.supplierPackage')}}" target="_blank" class="a_hover_class text-white mb-3" style="width: 120px;text-align: center">Details</a>
                    </div>
