...
{{--                                                <a href="{{route('register')}}" class="flex items-center mt-auto text-white bg-gray-700 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-900 rounded" style="justify-content: center">Subscribe</a>--}}
                                                <a href="{{route('register')}}" class="flex items-center mt-auto text-white bg-gray-700 border-0 py-3 px-4 w-full focus:outline-none hover:bg-gray-900 rounded" style="justify-content: center;font-size: 11px;">(Purchases above SR 5 million/month)</a>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
