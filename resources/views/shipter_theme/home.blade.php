                    ...
                    <div class="row">
                        <div class="col-xl-12 slide-caption">
                            ...
                            <h3 class="text-white emdad_description">
                                Emdad, is a digital B2B platform for procurement management.
                                It was established by an ambitious and technical expert team to transform purchasing, payment and supply processes in small,
                                medium and large companies into one digital unified platform. Nevertheless, it offers the lowest costs yet the best digital
                                and logistical standards. Emdad aims to make the local procurement operations in the Kingdom of Saudi Arabia more intelligent,
                                advanced and sustainable, according to 2030 vision.
                            </h3>
                            <div>
                            ...
                            <div class="price-item" style="height: 391px">
                                ...
                                <div class="pricing-table">
                                    ...
                                    <div class="btns text-center mt-3">
                                        <a href="{{route('english.buyerPackage')}}" class="a_hover_class text-white" style="width: 120px;text-align: center">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
