                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12 slide-caption">
                            ...
                            <h3 class="text-white emdad_description">
                                Emdad, is an online B2B platform for procurement management.
                                It was established by an ambitious and technical expert team to transform procurement processes into one digital unified platform.
                                Nevertheless, it offers the lowest costs yet the best digital and logistical standards. Emdad aims to make the local procurement operations
                                in the Kingdom of Saudi Arabia more intelligent, advanced and sustainable, according to 2030 vision.
                            </h3>
                            <div>
                    ...
                    <div class="features-item features-item-2">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="feature-wrap">
                                <div class="features-icon features-icon2" style="background-color: #505050; border-color: #c7e0f9">
                                    {{--<i><img src="{{url('Shipter/assets/images/icon/1.png')}}" alt="" style="width: 40px; transform: rotate(-45deg);"></i>--}}
                                    <i><img src="{{url('Shipter/assets/images/homepage/smart_map.png')}}" alt="" style="width: 75px; transform: rotate(-45deg);"></i>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="feature-wrap">
                                <div class="features-icon feature-icon3" style="background-color: #505050; border-color: #c7e0f9">
                                    {{--<i><img src="{{url('Shipter/assets/images/icon/2.png')}}" alt="" style="width: 40px;"></i>--}}
                                    <i><img src="{{url('Shipter/assets/images/homepage/privacy_safety.png')}}" alt="" style="width: 55px;"></i>
                                </div>
                                <div class="features-text">
                ...
                <div class="col-lg-4">
                    <div class="features-item">
                        <div class="col-lg-12 col-md-6 col-sm-12">
                            <div class="feature-wrap">
                                <div class="features-icon" style="background-color: #505050; border-color: #c7e0f9">
                                    {{--<i><img src="{{url('Shipter/assets/images/icon/3.png')}}" alt="" style="width: 40px;"></i>--}}
                                    <i><img src="{{url('Shipter/assets/images/homepage/saving_time_effort.png')}}" alt="" style="width: 55px;"></i>
                                </div>
                                <div class="features-text">
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-12">
                            <div class="feature-wrap">
                                <div class="features-icon" style="background-color: #505050; border-color: #c7e0f9">
                                    ...
                                    <i><img src="{{url('Shipter/assets/images/homepage/quality_performance.png')}}" alt="" style="width: 63px;"></i>
                                </div>
                                <div class="features-text">
            ...
            <div class="row">
                <div class="col-lg-6  offset-lg-6 about-wrap">
                    <div class="about-content">
                        ...
                        <span><strong>Our Vision:</strong> To become the largest, reliable digital platform to serve the small, medium and large companies, and to gain the biggest
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-l2 col-md-6 col-sm-6 mb-3">
                            <div class="price-item" style="height: 391px">
                                ...
                                <div class="pricing-table">
                                    ...
                                    <div class="pricing-footer" style="margin-top: 26%;">
                                        <div class="btns">
                        ...
                        <div class="col-lg-3 col-l2 col-md-6 col-sm-6 mb-3">
                            <div class="price-item">
                                ...
                                <div class="pricing-table">
                                    <div class="price-sub-header">
                                        <h5 style="color: #eb8e23">Free <br> (If the monthly purchases value exceeded 5 million SR))</h5>
                                    </div>
