...
{{--                            <h2><span>We Provide the Best Solution</span> <span>For Your Transport.</span></h2>--}}
                            <h3 class="text-white emdad_description" style="font-family: arabicFont;direction: rtl;">منصة إمداد هي منصة B2B رقمية لإدارة المشتريات، تم إنشاؤها على أيدي فريق طموح وخبير في المجال التقني بهدف تحويل عمليات الشراء والدفع والتوريد في المنشآت الصغيرة والمتوسطة والكبيرة إلى منصة رقمية وموحدة، بأقل التكاليف وبأفضل المعايير الرقمية واللوجستية، ولتصبح عمليات المشتريات المحلية في المملكة العربية السعودية أكثر ذكاءً وتقدماً واستدامة، وفقاً لرؤية ٢٠٣٠.</h3>
                            <div>
...
{{--                                <div class="btn-style"><a href="{{route('arabic.about')}}">من إمداد</a></div>--}}
    ...
    <div class="pricing-area pricing-area-2" style="direction: rtl; text-align: right;align-items: center">
        <div class="col-8">
                        ...
                        <div class="service-single">
                            ...
                            <div class="service-content service-content4">
                                <h3>
                                    ...
                                    <img src="{{url('Shipter/assets/images/service/purchase_department.png')}}" style="width: 72px; height: 59px; left: -80px; top: -26px; position: absolute" alt="">
                                    إدارة المشتريات
                                </h3>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: left;direction: rtl;">
                            <div class="feature-wrap">
                                ...
                                <div class="features-text">
                                    ...
                                    <p>من أعظم إنجازات فريق إمداد هو عمل الخارطة الذكية وتعتبر الأولى في مجالها والرائدة لتمكن المستخدم من الوصول للمورد الصحيح خلال دقيقة واحدة في أكثر من ٥٠٠ فئه متاحة.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: left;direction: rtl;">
                        ...
                        <div class="col-lg-3 col-l2 col-md-6 col-sm-6 mb-3">
                            <div class="price-item" style="height: 92%">
                                <div class="pricing-header" style="border-color: #023989; border-style: groove; border-width: thin;">
                                    ...
                                    <span style="color: black;font-family: sans-serif">EB-0000567373</span>
                                </div>
                                <div class="pricing-table">
                                    ...
                                    <div class="btns text-center mt-3">
                                        <a href="{{route('arabic.buyerPackage')}}" class="a_hover_class text-white" style="width: 120px;text-align: center">التفاصيل</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-l2 col-md-6 col-sm-6 mb-3">
                            <div class="price-item">
                                <div class="pricing-header3" style="border-color: #023989; border-style: groove; border-width: thin;">
                                    <h3 style="color: white;">البلاتينية</h3>
                                    <span style="color: black;font-family: sans-serif">EB-0000567373</span>
                                </div>
                                <div class="pricing-table">
                                    <div class="price-sub-header">
                                        <h5 style="color: #eb8e23">إذا كانت قيمة المشتريات الشهرية أعلى من ٥ ملايين ريال سعودي.
                                        </h5>
                                    </div>
