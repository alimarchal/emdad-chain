...
{{--                            <h2><span>We Provide the Best Solution</span> <span>For Your Transport.</span></h2>--}}
                            <h3 class="text-white emdad_description" style="font-family: arabicFont;direction: rtl;">منصة إمداد الرقمية هي منصة B2B لإدارة المشتريات، تم إنشاؤها على أيدي فريق طموح وخبير في المجال التقني بهدف تحويل عمليات الشراء والدفع والتوريد في المنشآت الصغيرة والمتوسطة والكبيرة إلى منصة رقمية وموحدة، بأقل التكاليف وبأفضل المعايير الرقمية واللوجستية؛ لتصبح عمليات المشتريات المحلية في المملكة العربية السعودية أكثر ذكاءً وتقدماً واستدامة، وفقاً لرؤية ٢٠٣٠.</h3>
                            <div>
