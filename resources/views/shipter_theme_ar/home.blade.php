                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: right;direction: rtl;">
                            <div class="feature-wrap">
                                ...
                                <div class="features-text">
                                    ...
                                    <p>من أعظم إنجازات إمداد هو عمل الخارطة الذكية وتعتبر الأولى في مجالها والرائدة لتمكن المستخدم من الوصول للمورد الصحيح خلال دقيقة واحدة في أكثر من ٥٠٠ فئه متاحة.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: right;direction: rtl;">
            ...
            <div class="row">
                <div class="col-lg-6   about-wrap">
                    <div class="about-content">
                        ...
                        <ul style="list-style-type: square; color: white; direction: rtl;">
                            <li class="mb-4"><strong>رؤيتنا لمستقبلنا:</strong> أضخم منصة تقنية موثوقة تخدم سلاسل الإمداد وتمتلك اكبر عدد من الموردين وأضخم اسطول لوجستي بأفضل معايير الجودة العالمية.</li>
                            <li><strong>هدفنا:</strong> إزالة جميع المعوقات اللوجستية ورفع مستوى خدمة سلاسل الإمداد لجميع شركاء إمداد، وسنفعل!</li>
                        </ul>
                    </div>
                    <br>
