                                    ...
                                    <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                                        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative bg-white overflow-hidden" style="border: 2px solid #c3c3c3">
                                            ...
                                            @if($package->package_type == 'Basic')
                                                ...
                                                <h1 class="text-3xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">مجاني</h1>
                            ...
                            <div class="lg:w-2/9 w-full mx-auto overflow-auto">
                                <table class="table-auto bg-white overflow-hidden w-full text-left whitespace-no-wrap">
                                    ...
                                    <tr>
                                        ...
                                        @foreach($packages as $package)
                                            <td class="px-4 py-3 text-center">@if($package->id == 5) مجاني @else {{$package->charges}}@endif</td>
                                        @endforeach
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($packages as $package)
                                            <td class="border-t-2 text-center border-gray-200 px-4 py-3">@if($package->id == 7) غير محدود  @else {{$package->quotations}}@endif</td>
                                        @endforeach
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($packages as $package)
                                            <td class="border-t-2 text-center border-gray-200 px-4 py-3">@if($package->id == 7) غير محدود  @else {{$package->truck}}@endif</td>
                                        @endforeach
                                    </tr>
                                    <tr>
