<x-app-layout>
    ...
    <form action="{{route('invoice_payment_status')}}?invoice_id={{$invoice->id}}&merchant_id={{$merchant_id->id}}&gateway={{$gateway}}" method="get" class="paymentWidgets" data-brands="@if($gateway == "mada") MADA @else VISA MASTER @endif">
    </form>
