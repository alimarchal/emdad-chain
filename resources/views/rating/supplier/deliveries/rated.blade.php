        ...
        <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="py-3">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <h2 class="text-2xl font-bold text-center text-blue-600">{{__('portal.Rated deliveries List')}}</h2>
                            @if ($deliveries->count())
                                                    ...
                                                    <tbody class="bg-white divide-y divide-gray-200">
                                                        @foreach ($deliveries as $delivery)
                                                            <tr>
                                                                ...
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                                    <a href="{{ route('supplierRatedViewByID', encrypt($delivery->id)) }}" class="hover:underline hover:text-blue-800 text-blue-500" target="_blank" rel="noreferrer">
