                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                                    @php
                                                                        ...
                                                                        $shipmentItem = \App\Models\ShipmentItem::where('delivery_id', $delivery->id)->first();
                                                                    @endphp
                                                                    <span class="badge badge-info">@if($loop->iteration == 1) <span style="font-family: sans-serif">{{ $user->name }}</span> @else {{__('portal.Emdad')}} @endif</span>
                                                                </td>
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                                    <span class="badge badge-info">@if($loop->iteration == 1) <span style="font-family: sans-serif">{{ $user->business->business_name }}</span> @else {{__('portal.Emdad Supply Chain')}} @endif</span>
                                                                </td>
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500" style="font-family: sans-serif">
                                                                    <span class="badge badge-info"> @if(isset($deliveryComment->comment_content)) {{ $deliveryComment->comment_content }} @else {{__('portal.N/A')}} @endif </span>
                                                                </td>
