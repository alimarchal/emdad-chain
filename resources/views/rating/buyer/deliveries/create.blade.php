                ...
                <form method="post" action="{{route('storeBuyerRatedToDelivery')}}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <h3 class="text-2xl font-bold text-center text-blue-600">Rate</h3>
                            ...
                            <div class="grid grid-cols-8 gap-6 mt-2">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label class="block font-medium text-sm text-gray-700" for="supplier_rating">Rate</label>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label class="block font-medium text-sm text-gray-700" for="supplier_comment_content">Comments</label>
                                    <textarea name="supplier_comment_content" id="supplier_comment_content" class="w-full" style="border: 2px solid #d6d8db; border-radius: 8px;" maxlength="254" cols="50" placeholder="Any Comments...">{{old('supplier_comment_content')}}</textarea>
                                </div>
                            ...
                            <div class="grid grid-cols-8 gap-6 mt-2">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label class="block font-medium text-sm text-gray-700" for="driver_rating">Rate</label>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <textarea name="driver_comment_content" id="driver_comment_content" class="w-full" style="border: 2px solid #d6d8db; border-radius: 8px;" maxlength="254" cols="50" placeholder="Any Comments...">{{old('driver_comment_content')}}</textarea>
                                </div>
