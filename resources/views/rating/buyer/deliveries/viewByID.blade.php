        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="py-3">
                        <div class="mt-5" style=" margin-left: 30px; margin-bottom: 10px "> </div>
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                                    ...
                                                    <tbody class="bg-white divide-y divide-gray-200">
                                                        @foreach ($deliveryComments as $deliveryComment)
                                                            <tr>
                                                                ...
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                                    <span>
                                                                    @if($deliveryComment->comment_type == 1 ) {{__('portal.Driver')}}
                                                                        @elseif($deliveryComment->comment_type == 5 ) {{__('sidebar.Supplier')}}
                                                                        @elseif($deliveryComment->comment_type == 7 ) {{__('portal.Emdad')}}
                                                                        @endif
                                                                    </span>
                                                                </td>
                                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
