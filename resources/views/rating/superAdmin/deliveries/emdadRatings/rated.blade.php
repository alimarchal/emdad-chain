                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                            <span class="badge badge-info">
                                                                <a href="{{route('delivery.show', encrypt($deliveryComment->delivery_id))}}" class="text-blue-600 hover:underline" target="_blank"> {{ $deliveryComment->delivery_id }} </a>
                                                            </span>
                                                        </td>
                                                        @php
                                                            /*$deliveryComment = \App\Models\DeliveryComment::where('delivery_id', $delivery->id)->first();
                                                            $deliveryComments = \App\Models\DeliveryComment::where('delivery_id', $delivery->id)->get();
                                                            $sum = 0;
                                                        ...
                                                        @endphp
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                            <a href="{{ route('emdadRatedViewByID',$deliveryComment->delivery_id) }}" class="hover:underline hover:text-blue-800 text-blue-500" target="_blank">
