        ...
        <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="py-3">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <h2 class="text-2xl font-bold text-center text-blue-600">{{__('portal.Buyers List')}}</h2>
                                                ...
                                                <table class="min-w-full divide-y divide-gray-200" id="roles-table">
                                                    ...
                                                    @foreach ($deliveries as $delivery)
                                                        <tr>
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                                <span class="badge badge-info">{{ $delivery->buyer->name }}</span>
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                                <span class="badge badge-info">{{ $delivery->buyer->business->business_name }}</span>
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                                                <a href="{{ route('rateBuyer', [ 'id' => $delivery->user_id,  'deliveryID' => $delivery->id]) }}" class="text-green-600 inline-block hover:text-green-900" title="Rate">
