    ...
    <div>
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{route('storeBuyerRating')}}">
                    @csrf
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    {{--<select name="role" id="role" class="form-input rounded-md shadow-sm mt-1 block w-full js-example-basic-single" required>
                                        ...
                                        @foreach($buyers as $buyer)
                                            <option value="{{$buyer->id}}">{{$buyer->business->business_name}}</option>
                                        @endforeach
                                    </select>--}}
                                </div>
                                <div class="col-span-6 sm:col-span-2">
