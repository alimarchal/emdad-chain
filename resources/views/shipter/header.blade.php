                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-12 col-lg-6">
                        <ul class="d-flex account_login-area">
                            <li>
                                <a href="{{route('arabic.index')}}" class="scrollto btn btn-warning" style="background: #eb8e23;border-color: white;"><img alt="" src="{{url('sa.png')}}" style="margin-right: 2px;margin-top:-4px; font-family: arabicFont;">&nbsp;العربية</a>
                            </li>
                    ...
                    <div class="col-md-6 col-sm-12 col-12 col-lg-6">
                        <div class="row">
                            <div class="col-lg-9 col-md-6">
                                <ul class="login-r">
                                    <li><a style="color: white" href="{{route('register')}}">Register with us
                                        </a></li>
                                </ul>
                            </div>
