<div class="col-md-6 col-sm-12 col-12 col-lg-6">
    <ul class="d-flex account_login-area">
        <li><a href="{{route('arabic.index')}}" class="btn btn-warning" style="background: #eb8e23;border-color: white;"><img alt="" src="{{url('sa.png')}}"
                                                                            style="margin-right: 2px;margin-top:-4px; font-family: arabicFont;">&nbsp;العربية</a></li>
