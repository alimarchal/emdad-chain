<x-app-layout>
    ...
    @endif
    <h2 class="text-2xl font-bold py-2 text-center m-15">Items List  seems empty 
    </h2>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            @foreach ($collection as $rfp)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('RFQItemsByID',$rfp->RFQ->id) }}" class="text-blue-900 hover:underline hover:text-blue-900">RFQ-{{ $rfp->RFQ->id }}</a>
                                    </td>
