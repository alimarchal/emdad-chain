...
<x-app-layout>
   ...
   .file-label:hover
   {
    ...
    <div class="flex flex-col bg-white rounded mb-5">
        <div class="cart">
            @if ($eCart->count())
            @php $total = 0; @endphp
                                ...
                                <tr>
                                    ...
                                    <td class="px-8 py-3 whitespace-nowrap">
                                        <select name="company_name_check" id="company_name_check"
                                            onchange="companyCheck({{$rfp->id}})"
                                            class="form-select shadow-sm block w-full" required>
                                            <option {{($rfp->company_name_check == 0) ? 'selected' : ''}} value="0">No
                                            </option>
                                            <option {{($rfp->company_name_check == 1) ? 'selected' : ''}} value="1">Yes
                                            </option>
                                        </select>
                                        <span style="display: none" id="status"
                                            class="text-green-600 text-sm-center">Status Updated.</span>
                                    </td>
    ...
    <div class="flex flex-col bg-white rounded">
        ...
        <div class="p-4" style="background-color: #F3F3F3">
             <div class="d-block text-center">
                     <span class="text-2xl font-bold">Request For Quotation</span>
                    
                 </div>
                 <hr>
            <div style=" height: 145px;" class="container-fluid px-4 flex bg-grey">
                ...
                @endphp
                <div style="margin-top: 20px;margin-bottom: 20px;padding-left: 20px;">
                    <h1 class="font-extrabold">{{$user_business_details->business_name}}</h1>
                    <span>Location :
                ...
                <div class="flex-1 ">
                    <div class="ml-auto" style="width:150px; ">
                         <br>
                        <span>Date: {{\Carbon\Carbon::today()->format('Y-m-d')}}</span><br>
                        <hr>
                    </div>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('RFQCart.store') }}" enctype="multipart/form-data">
            ...
            <div class="p-4 mb-3">
                <div>
                    <div style="background: #ffd966; min-height: 235px;padding-top: 1px;" class="md:flex">
                        ...
                        <div class="left-info_holder md:flex-1">
                            ...
                            <div class="my-5 pl-5 ">
                                Display Company Name:<div class="relative inline-flex ">
                                    ...
                                    <select
                                        ...
                                        <option @if(isset($latest_rfq)){{$latest_rfq->company_name_check == 0 ? 'selected' : ''}}
                                             @endif value="0">No</option>
                                        <option @if(isset($latest_rfq)){{$latest_rfq->company_name_check == 1  ? 'selected' : ''}}
                                             @endif value="1">Yes</option>
                                    </select>
                                </div>
                                <br>
                                Payment Mode:<div class="relative inline-flex">
                                    <svg class="w-2 h-2 absolute top-0 right-0 mt-4 pointer-events-none"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232">
                                        <path
                                            d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z"
                                    ...
                                    <select
                                        ...
                                        <option value="Cash" @if (isset($latest_rfq))
                                            {{$latest_rfq->payment_mode =='Cash' ? 'selected' : ''}}  @endif>Cash</option>
                                        ...
                                        <option value="Credit" @if (isset($latest_rfq))
                                            {{$latest_rfq->payment_mode =='Credit' ? 'selected' : ''}}  @endif>Credit</option>
                                        <option value="Credit30days" @if (isset($latest_rfq))
                                            {{$latest_rfq->payment_mode =='Credit30days' ? 'selected' : ''}}  @endif>Credit (30
                                            Days)</option>
                                        <option value="Credit60days" @if (isset($latest_rfq))
                                            {{$latest_rfq->payment_mode =='Credit60days' ? 'selected' : ''}}  @endif>Credit (60
                                            Days)</option>
                                        <option value="Credit90days" @if (isset($latest_rfq))
                                            {{$latest_rfq->payment_mode =='Credit90days' ? 'selected' : ''}}  @endif>Credit (90
                                            Days)</option>
                                        <option value="Credit120days" @if (isset($latest_rfq))
                                            {{$latest_rfq->payment_mode =='Credit120days' ? 'selected' : ''}} @endif>Credit (120
                                            Days)</option>
                                        @endif
                                    </select>
                                </div> <br>
                                Unit of Measurement:<div class="relative inline-flex">
                                    <svg class="w-2 h-2 absolute top-0 right-0 mt-4 pointer-events-none"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232">
                                        <path
                                            d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z"
                                    ...
                                    <select
                                        ...
                                        <option value="{{$item->uom_en}}" 
                                       @if (isset($latest_rfq))
                                             {{($latest_rfq->unit_of_measurement ==  $item->uom_en ? 'selected' : '')}}
                                       @endif
                                      >{{$item->uom_en}}</option>
                                        @endforeach
                                ...
                                Required Sample:<div class="relative inline-flex">
                                    <svg class="w-2 h-2 absolute top-0 right-0 mt-4 pointer-events-none"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232">
                                        <path
                                            d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z"
                                    ...
                                    <select
                                        ...
                                        {{$latest_rfq->required_sample =='Yes' ? 'selected' : ''}}  @endif>Yes</option>
                                        <option value="No" @if (isset($latest_rfq))
                                        {{$latest_rfq->required_sample =='Yes' ? 'selected' : ''}}   @endif>No</option>
                            ...
                            <div class="my-5 pl-5 ">
                                ...
                                Delivery Period:<div class="relative inline-flex">
                                    ...
                                    <select
                                        ...
                                        {{$latest_rfq->delivery_period =='Immediately' ? 'selected' : ''}}  @endif>Immediately</option>
                                        <option value="Within 30 Days" @if (isset($latest_rfq))
                                        {{$latest_rfq->delivery_period =='Within 30 Days' ? 'selected' : ''}} @endif>30 Days</option>
                                        <option value="Within 60 Days" @if (isset($latest_rfq))
                                        {{$latest_rfq->delivery_period =='Within 60 Days' ? 'selected' : ''}}   @endif >60 Days</option>
                                        <option value="Within 90 Days">90 Days</option>
                                        <option value="Standing Order - 2 per year" @if (isset($latest_rfq))
                                        {{$latest_rfq->delivery_period =='Standing Order - 2 per year' ? 'selected' : ''}}   @endif>Standing Order - 2 times / year
                                        </option>
                                        <option value="Standing Order - 3 per year"  @if (isset($latest_rfq))  {{$latest_rfq->delivery_period =='Standing Order - 3 per year' ? 'selected' : ''}}  @endif>Standing Order - 3 times / year
                                        </option>
                                        <option value="Standing Order - 4 per year"   @if(isset($latest_rfq)) {{$latest_rfq->delivery_period =='Standing Order - 4 per year' ? 'selected' : ''}}  @endif>Standing Order - 4 times / year
                                        </option>
                                        <option value="Standing Order - 6 per year"   @if(isset($latest_rfq)) {{$latest_rfq->delivery_period =='Standing Order - 6 per year' ? 'selected' : ''}}  @endif>Standing Order - 6 times / year
                                        </option>
                                        <option value="Standing Order - 12 per year" @if(isset($latest_rfq))    {{$latest_rfq->delivery_period =='Standing Order - 12 per year' ? 'selected' : ''}}   @endif>Standing Order - 12 times / year
                                        </option>
                                        <option value="Standing Order Open"   @if(isset($latest_rfq)) {{$latest_rfq->delivery_period =='Standing Order Open' ? 'selected' : ''}}  @endif>Standing Order - Open</option>
            ...
            <div class="p4 mb-5 overflow-x-auto">
                ...
                <table class="table-fixed text-center min-w-full " style="margin-left:50px; margin-right:50px;">
                    <thead style="background-color:#ed7d31" class="text-white">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="description" id="description" class="w-full"
                                    style="border: 2px solid #BAB6B6FF; border-radius: 4px; resize: none; margin-top:8px; max-height: 30px;"
                            ...
                            <td>
                                <input class="form-input rounded-md shadow-sm  w-full" id="size" type="text"
                                    name="size" min="0" placeholder="Size">
                            </td>
                            ...
                            <td>
                                <input class="form-input rounded-md shadow-sm w-full" id="last_price"
                                    type="number" name="last_price" min="0" autocomplete="last_price"
                                    placeholder="Price">
                            </td>
