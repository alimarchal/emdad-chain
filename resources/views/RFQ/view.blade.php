                ...
                <div class="md:flex flex-1 rounded-md bg-white">
                    ...
                    <div class="lg:flex flex-1 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div class="items-center text-center px-2 py-6 ">
                            ...
                            <div class="mx-5">
                                <div class="text-gray-500"><a href="{{route('PlacedRFQ.index')}}"
            ...
            <div class="w-full overflow-hidden lg:my-2 lg:px-2 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                ...
                <div class="md:flex flex-1 rounded-md bg-white">
                        ...
                        <div class="items-center text-center px-2 py-6 ">
                            ...
                            <div class="mx-5">
                                <div class="text-gray-500"><a href="{{route('create_single_rfq')}}"
                                                              class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-red active:bg-blue-600 transition ease-in-out duration-150">Create
                                        RFQ</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:flex flex-1 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div class="items-center text-center px-2 py-6 ">
                            <div class="mx-5">
                                <div class="text-gray-500"><a href="{{route('single_category_rfq_index')}}"
