                ...
                <div class="md:flex flex-1 rounded-md bg-white">
                        ...
                        <div class="items-center text-center px-2 py-6 ">
                            ...
                            <div class="mx-5">
                                <div class="text-gray-500">
                                    ...
                                    <a href="{{route('RFQCart.index')}}" class="inline-flex items-center justify-center px-4  py-3  bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-blue-500 focus:shadow-outline-red active:bg-blue-500 transition ease-in-out duration-150">
                    ...
                    <div class="lg:flex flex-1 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div class="items-center text-center px-2 py-6 ">
                            ...
                            <div class="mx-5">
                                <div class="text-gray-500">
                                    <a href="{{route('PlacedRFQ.index')}}" class="inline-flex items-center justify-center px-4  py-3  bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-blue-500 focus:shadow-outline-red active:bg-blue-500 transition ease-in-out duration-150">
                                        RFQ History
                                    </a>
                                </div>
                            </div>
                ...
                <div class="md:flex flex-1 rounded-md bg-white">
                        ...
                        <div class="items-center text-center px-2 py-6 ">
                            ...
                            <div class="mx-5">
                                <div class="text-gray-500">
                                    ...
                                    <a href="{{route('single_cart_index')}}" class="inline-flex items-center justify-center px-4 @if($count > 0) py-3 @else py-3 @endif bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-blue-500 focus:shadow-outline-red active:bg-blue-500 transition ease-in-out duration-150">
                    ...
                    <div class="lg:flex flex-1 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div class="items-center text-center px-2 py-6 ">
                            <div class="mx-5">
                                <div class="text-gray-500">
                                    <a href="{{route('single_category_rfq_index')}}" class="inline-flex items-center justify-center px-4  py-3  bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-blue-500 focus:shadow-outline-red active:bg-blue-500 transition ease-in-out duration-150">
                                        RFQ History
                                    </a>
                                </div>
                            </div>
