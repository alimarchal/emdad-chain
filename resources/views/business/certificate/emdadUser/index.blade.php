...
@if (auth()->user()->rtl == 0)
    <x-app-layout>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight"> {{ __('Business New Certificate(s) Requests') }} </h2>
        </x-slot>
                    ...
                    <div class="py-3">
                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            @if ($businessCertificates->count())
                                ...
                                <h2 class="text-2xl font-bold text-center">{{__('portal.Business New Certificate(s) Requests')}}</h2>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                                                <div class="text-sm text-gray-900">
                                                                    {{ isset($businessCertificate->business->business_name) ? $businessCertificate->business->business_name : __('portal.N/A')  }}
                                                                </div>
                                                            </td>
                                                                ...
                                                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                                                    <div class="text-sm text-gray-900">
                                                                        ...
                                                                        @elseif($businessCertificate->legal_officer_status == 1)
                                                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100  text-green-800">{{__('portal.Accepted')}}</span>
                                                                ...
                                                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                                                    <div class="text-sm text-gray-900">
                                                                        <a class="bg-green-500 text-white active:bg-green-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1"
                                                                           href="{{route('certificateBusinessStatusUpdate', $businessCertificate->id)}}" style="transition: all .15s ease"> {{__('portal.Update')}}
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            @endif
                                                            ...
                                                            @if(auth()->user()->hasRole('Legal Approval Officer 1'))
                                                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                                                    @if($businessCertificate->legal_officer_status == 0)
                                                                        <div class="text-sm text-gray-900">
                                                                            <a class="bg-green-500 text-white active:bg-green-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1"
                                                                               href="{{route('certificateStatusUpdate', [ 'id' => $businessCertificate->id,  'status' => 1])}}" style="transition: all .15s ease"> {{__('portal.Accept')}}
                                                                            </a>
                                                                            ...
                                                                            <a class="bg-red-500 text-white active:bg-red-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1"
                                                                               href="{{route('certificateStatusUpdate', ['id' => $businessCertificate->id, 'status' =>  2])}}" style="transition: all .15s ease"> {{__('portal.Reject')}}
                                                                            </a>
                                                                        </div>
                                                                    @elseif($businessCertificate->legal_officer_status == 1)
                                                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100  text-green-800">{{__('portal.Accepted')}}</span>
                                                                    ...
                                                                    <td class="px-6 py-4 text-center whitespace-nowrap">
                                                                        @if($businessCertificate->legal_officer_status == 0)
                                                                            <div class="text-sm text-gray-900">
                                                                                ...
                                                                                <a class="bg-red-500 text-white active:bg-red-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md hover:text-white outline-none focus:outline-none mr-1 mb-1"
                                                                                   href="{{route('certificateStatusUpdate', ['id' => $businessCertificate->id, 'status' =>  2])}}" style="transition: all .15s ease"> {{__('portal.Reject')}}
                                                                                </a>
                                                                            </div>
                                                                        @elseif($businessCertificate->legal_officer_status == 1)
