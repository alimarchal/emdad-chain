<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <span
                class="float-right text-red-900 font-bold">{{(isset(Auth::user()->status) == 1)?'Under process':'InComplete'}}</span>
                    ...
                    <form action="{{route('category.store')}}" method="post">
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12">
                                ...
                                <label class="block font-medium text-sm text-gray-700 mt-4" style="direction: rtl;"
                                    for="name_ar">
                                    اسم التصنيف بالعربي
                                </label>
                                <input class="form-input rounded-md shadow-sm mt-1 block w-full" id="name_ar"
                                    style="direction: rtl;" type="text" name="name_ar" required>
