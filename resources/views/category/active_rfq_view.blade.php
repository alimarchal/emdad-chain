<x-app-layout>
    ...
    @endif
    <h2 class="text-2xl font-bold py-2 text-center m-15">Items List @if (!$activeRFQs->count()) seems empty @endif </h2>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            @foreach ($activeRFQs as $rfp)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            $record = \App\Models\Category::where('id',$rfp->category->id)->first();
