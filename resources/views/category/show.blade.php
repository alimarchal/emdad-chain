    ...
    <x-app-layout>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('dashboard.Dashboard') }} - {{__('portal.Welcome')}}
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="px-4 py-5 sm:p-6 bg-white shadow sm:rounded-lg">
                        <h2 class="text-2xl font-bold text-center">{{__('portal.All Categories')}}</h2>
                        <h3 class="text-2xl text-blue-600">{{__('portal.Category')}} -- {{__('portal.Registered Buyers')}} -- {{__('portal.Registered Suppliers')}} -- {{__('portal.Active Requisitions')}}</h3>
