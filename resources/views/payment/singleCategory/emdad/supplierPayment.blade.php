    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                @if ($payments->count())
                                    @php
                                        /* Checking delivery status so that Emdad can send payment to supplier. Emdad can send payment to supplier if delivery is delivered */
                                        $delivery = \App\Models\Delivery::where('id',$payments[0]->delivery_id)->first();
                                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-black">
                                                    @php
                                                        ...
                                                        // Retrieving all bank payments related to same rfq_no
                                                        $bankPayments = \App\Models\BankPayment::where('rfq_no', $payments[0]->rfq_no)->get();
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-black">
                                                    ...
                                                    @elseif($delivery->status == 4)
                                                        Returned
                                                    @elseif($delivery->shipment_status == 0)
                                                        Not Delivered
                                                    @endif
                                                </td>
                                                ...
                                                @if($delivery->status == 1)
                                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-black">
                                                        <a href="{{ route('singleCategoryAdminSupplierPaymentView',$payment->rfq_no) }}" class="hover:underline hover:text-blue-800 text-blue-500" target="_blank">
