            ...
            <div class="bg-white overflow-hidden shadow-xl ">
                <div class="px-4 py-5 sm:p-6 bg-white shadow ">
                    ...
                    <div class="flex flex-wrap overflow-hidden bg-white p-4">
                        ...
                        <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3 ">
                            <strong>Invoice #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>Emdad-{{ $invoice->id }}<br>
                    ...
                    <div class="flex flex-wrap overflow-hidden bg-white p-4">
                        ...
                        <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3 ">
                            <strong>Purchase Order #: &nbsp;&nbsp;</strong>Emdad-{{ $invoice->purchase_order->id }}<br>
                            <strong>Category Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ $invoice->purchase_order->item_name }}<br>
                            <strong>RFQ #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>Emdad-{{ $invoice->purchase_order->rfq_no }}<br>
                            <strong>Quote #: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>Emdad-{{ $invoice->purchase_order->qoute_no }}<br>
