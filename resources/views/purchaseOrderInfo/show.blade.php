        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="px-4 py-0 bg-white sm:p-6">
                    <h1 class="text-center text-3xl font-bold p-4 border-t-2 bg-opacity-5 border-black border-2"> Purchase Order Information of {{$business->business_name}}</h1>
                    <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 text-gray-500 items-center border-2 border-t-0 border-cool-gray-700">
                        <div class="flex flex-wrap overflow-hidden">
                            ...
                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3 h-12 text-lg text-black">
                                <p><strong>Total No of Monthly Order:</strong> {{$purchaseOrderInfo->no_of_monthly_orders}}</p>
                            </div>

                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3 h-12 text-lg text-black">
                                <p><strong>Volume:</strong> {{$purchaseOrderInfo->volume}}</p>
                            </div>

                            <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3 h-12 text-lg text-black">
                                <p><strong>Type:</strong> {{$purchaseOrderInfo->type}}</p>
                            </div>
