<div class="col-md-6 col-sm-12 col-12 col-lg-6">
    <ul class="d-flex account_login-area">
        <li>
            <a href="{{route('english.index')}}" class="btn btn-warning" style="background: #eb8e23;border-color: white;width: 100px;">
                <img alt="" src="{{url('us.png')}}" style="font-family: 'Raleway', sans-serif;margin-right: 2px;margin-top: 4px;">
                &nbsp;English
            </a>
        </li>
        <li>
