            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-9 col-sm-9 col-9">
                        <div class="logo">
                            <a href="{{route('english.index')}}"><img src="{{url('logo-full.png')}}" alt="" style="max-height: 38px"></a>
                        </div>
                    </div>
                    <div class="col-lg-8 d-none d-lg-block">
                        <div class="main-menu">
                            <nav class="nav_mobile_menu">
                                <ul>
                                    <li class="{{(request()->routeIs('english.index')?'active':'')}}"><a href="#">Home</a></li>
...
<section class="hero hero-slider-wrapper hero-style-1 hero-style-2">
    <div class="hero-slider">
        <div class="slide">
            <img src="{{url('Shipter/assets/images/slider/2.jpg')}}" alt class="slider-bg">
            <div class="container">
                <div class="row">
        ...
        <div class="slide">
            <img src="{{url('Shipter/assets/images/slider/1.jpg')}}" alt class="slider-bg">
            <div class="container">
                <div class="row">
                    <div class="col col-lg-9 slide-caption">
                        <h2><span>We Provide the Best Solution</span> <span>For Your Transport.</span></h2>
                        ...
                        <div class="price-item">
                            ...
                            <div class="pricing-table">
                                ...
                                <div class="pricing-footer">
                                    <div class="btns">
                                        <div class="btn-style btn-style-4"><a href="#">Order Now</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
