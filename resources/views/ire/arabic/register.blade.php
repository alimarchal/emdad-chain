...
{{--            </div>--}}
            ...
            <div class="block mt-4">
                <label for="policy_procedure" class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600" style="padding-right: 10px;">أوافق على</span> <a href="{{route('arabic.policyProcedure.ire')}}" target="_blank" class="ml-2 text-sm text-red-600"><u>{{ __(' الشروط والأحكام') }}</u></a>
                </label>
            </div>
