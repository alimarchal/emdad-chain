    ...
    <nav class="mt-10">
        <a class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('ireArabicDashboard') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{ route('ireArabicDashboard') }}">
            ...
            <span class="mx-3">لوحة القيادة</span>
        </a>
        ...
        <a class="flex items-center mt-4 py-2 px-6  {{ request()->routeIs('ireArabicIncompleteReference') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}   hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="{{ route('ireArabicIncompleteReference') }}">
            ...
            <span class="mx-3">Incomplete Companies</span>
        </a>
        ...
        <div x-data="{ open: false } ">
            ...
            <ul x-show.transition.in.duration.50ms.out.duration.100ms="open" @click.away="open = false">
                <li class="flex items-center mt-4 py-2 px-6 {{ request()->routeIs('ireArabicPayment') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                    ...
                    <a href="{{ route('ireArabicPayment') }}" class="hover:text-white {{ request()->routeIs('ireArabicPayment') ? 'text-white' : 'text-gray-500' }}"><span class="mx-3">قائمة الأرباح</span></a>
                </li>
            </ul>
        </div>
