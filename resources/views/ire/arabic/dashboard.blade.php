            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white" style="height:100%;">
                    ...
                    <div class="mx-5">
                        ...
                        <div class="text-gray-500"><a href="{{route('ireReference')}}" style="font-family: Nunito,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;">مجموع الممثلين المستقلين الموصى لهم</a></div>
            ...
            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white" style="height:100%;">
                    ...
                    <div class="mx-5">
                        ...
                        <h4 class="text-2xl font-semibold text-gray-700"></h4>
                        <div class="text-gray-500"><a href="{{route('ireReference')}}" style="font-family: Nunito,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;">مجموع البائعين الموصى لهم</a></div>
            ...
            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white" style="height:100%;">
                    ...
                    <div class="mx-5">
                        ...
                        <h4 class="text-2xl font-semibold text-gray-700"></h4>
                        <div class="text-gray-500"><a href="{{route('ireReference')}}" style="font-family: Nunito,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;">مجموع المورّدين الموصى لهم</a></div>
