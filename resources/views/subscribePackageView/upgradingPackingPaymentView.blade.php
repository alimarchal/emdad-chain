<x-app-layout>
    ...
    <form action="{{route('businessPackageUpgradePaymentStatus')}}?package_id={{$package->id}}&merchant_id={{$merchant_id->id}}&gateway={{$gateway}}" method="get" class="paymentWidgets" data-brands="@if($gateway == "mada") MADA @else VISA MASTER @endif">
    </form>
