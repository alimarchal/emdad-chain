...
{{--        <input type="hidden" name="callback_url" value="" />--}}
        ...
        <form action="{{route('businessPackage.paymentStatus')}}?package_id={{$package->id}}" method="get" class="paymentWidgets" data-brands="MADA VISA MASTER">
...
{{--        <input type="hidden" name="callback_url" value="{{route('businessPackage.paymentStatus')}}" />--}}
{{--        <input type="hidden" name="publishable_api_key" value="{{config('moyasar.publishable_key')}}" />--}}

{{--        <input type="hidden" name="amount" value="{{$package->charges * 100}}" />--}}
{{--        <input type="hidden" name="source[type]" value="creditcard" />--}}
{{--        <input type="hidden" name="description" value="{{$package->id}}" />--}}
...
{{--            </div>--}}
{{--            <div class="mb-10">--}}
{{--                <h1 class="text-center font-bold text-xl uppercase">Secure payment infoss</h1>--}}
{{--            </div>--}}
