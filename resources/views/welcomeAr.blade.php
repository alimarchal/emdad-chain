            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-4 mt-md-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <h4><a href="#">للموردين</a></h4>
                        <p>
                            1- إمكانية طلب التقارير الالكترونية في أي وقت.
                            <br>
                            2- حفظ جميع العمليات والمستندات في سحابه إلكترونيه كمرجعية.
                            <br>
                            3- مراقبة ومتابعة صاحب الصلاحية لفريق المبيعات والمعاملات القائمة.
                            <br>
                            4- تعزيز وتمكين قدرات وخبرات العاملين بدورات تدريبية مجانية.
                            إمكانية اعتماد عروض الأسعار إلكترونيا<br>
                            5- نضمن لكم تحصيل الأموال في الوقت المحدد.
                            <br>
                            <br>
                            <br>
                            <br>
                ...
                <div class="col-md-6 mt-4 mt-md-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="500">
                        <i class="icofont-earth"></i>
                        <h4><a href="#">للمشترين</a></h4>
                        <p>
                            1- إمكانية الدفع الآمن.

                            <br>
                            2- إمكانية تتبع الشحنات.

                            <br>
                            3- إمكانية التعامل بالنقد أو بالآجل.
                            <br>
                            4- ضمانة طلب عروض الاسعار من المورد الصحيح.

                            <br>
                            4- إمكانية تسجيل الموردين والتعامل معهم بطريقة مباشرة.

                            <br>
                            4- تعزيز البحث عن منتج بديل او جديد بطريقه سهله وسريعة.
                            <br>
                            5- منع الاختلاسات المالية والتعامل السري بين البائع والمشتري.
                            <br>
                            6- منع الاختلاسات المالية والتعامل السري بين البائع والمشتري.
                        </p>
                    </div>
                </div>
