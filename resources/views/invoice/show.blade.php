                            ...
                            <div class="px-4 py-5 sm:p-6 bg-white shadow ">
                                ...
                                <div class="flex flex-wrap overflow-hidden bg-white p-4">
                                    ...
                                    <div class="w-full overflow-hidden lg:w-1/3 xl:w-1/3">
                                        ...
                                        <strong>{{__('portal.VAT')}} {{ number_format($draftPurchaseOrder->vat) }}%: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>{{ number_format(($draftPurchaseOrder->sub_total + $draftPurchaseOrder->shipment_cost) * ($draftPurchaseOrder->vat/100), 2) }} {{__('portal.SAR')}}<br>
