                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="whitespace-nowrap ml-10" style="text-align:center;">
                                                                    <span>
                                                                        ...
                                                                        @elseif($emdadInvoice->invoice->invoice_status == 1) {{__('portal.Verification Pending')}}
                                                                        @elseif($emdadInvoice->invoice->invoice_status == 2) {{__('portal.Rejected')}}
