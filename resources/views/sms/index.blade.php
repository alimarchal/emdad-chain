...
@if (auth()->user()->rtl == 0)
    <x-app-layout>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight"> {{__('portal.SMS List')}} </h2>
        </x-slot>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-4">
                    ...
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <h2 class="text-2xl font-bold text-center mt-4">{{__('portal.SMS List')}}</h2>
                        @if ($sms->count())
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200" id="roles-table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="text-center px-6 py-3 bg-gray-50 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                            {{__('portal.Action')}}
                                                        </th>
                                                    </tr>
                                                </thead>
