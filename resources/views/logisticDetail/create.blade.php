            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="px-4 py-0 bg-white sm:p-6 rounded-sm">
                    <form action="{{url('business')}}" method="post" class="form bg-white p-6  mb-4" enctype="multipart/form-data">
                        @csrf
                        <h3 class="text-2xl text-gray-900 font-semibold text-center">Logistic Details</h3>
                        <div class="flex space-x-5 mt-3">
                            <x-jet-label class="w-1/2" for="no_of_drivers">No of Drivers</x-jet-label>
                            <x-jet-label class="w-1/2" for="vehicle_types">Vehicle Types</x-jet-label>
