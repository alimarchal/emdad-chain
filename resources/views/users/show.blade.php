            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="px-4 py-0 bg-white sm:p-6 rounded-sm">
                    <form action="{{ url('users'). '/' . $user->id }}" method="post" class="form bg-white p-6" enctype="multipart/form-data">
                        ...
                        <div class="flex space-x-5 mt-3">
                            <input type="text" name="name" id="" placeholder="Name" class="border p-2 w-1/2" value="{{$user->name}}" readonly>
                            <input type="text" name="designation" id="" placeholder="Designation" class="border p-2 w-1/2" value="{{$user->designation}}" readonly>
                            <input type="text" name="email" id="email" placeholder="Email" class="border p-2 w-1/2" value="{{$user->email}}" readonly>
