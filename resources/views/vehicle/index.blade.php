                                                ...
                                                <table class="min-w-full divide-y divide-gray-200 " id="roles-table">
                                                    <thead class="bg-gray-50">
                                                        <tr>
                                                            ...
                                                            <th scope="col" class="px-6 py-30 text-center text-sm uppercase text-gray-500 tracking-wider" style="background-color: #FCE5CD;">
                                            ...
                                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                                ...
                                                <table class="min-w-full divide-y divide-gray-200 " id="roles-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="px-6 py-30 text-center text-sm text-gray-500 tracking-wider" style="background-color: #FCE5CD;">
                                                            {{__('portal.Vehicle Type')}}
                                                        </th>
                                                        <th scope="col" class="px-6 py-30 text-center text-sm text-gray-500 tracking-wider" style="background-color: #FCE5CD;">
                                                            {{__('portal.Licence')}} #
